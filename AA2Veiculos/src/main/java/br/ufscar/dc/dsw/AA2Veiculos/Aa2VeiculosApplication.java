package br.ufscar.dc.dsw.AA2Veiculos;
...
import br.ufscar.dc.dsw.AA2Veiculos.dao.IClienteDAO;
...
public class Aa2VeiculosApplication {

    public static void main(String[] args) {
        SpringApplication.run(Aa2VeiculosApplication.class, args);
    }
